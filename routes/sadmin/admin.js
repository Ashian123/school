...
exports.college_details = (req, res) => {
  ...
  db.query(sql, (err, college_details) => {
    ...
    db.query(sql, (err, data) => {
      res.render("sadmin/college_details.ejs", {
        state: data,
...
exports.admin_task = (req, res) => {
  res.render("sadmin/dropdown_menu.ejs");
};
...
exports.menu_status = (req, res) => {
  ...
  db.query(sql, (err, menu) => {
    res.render("sadmin/student-menu-admintask.ejs", {
      menu,
    });
  });
};
...
exports.getSubjects = (req, res) => {
  var sql = `SELECT subject from ${schema}.subjects`;
